...
export function IconEditar({ className }) {
  return (
    <svg {...base({ className })}>
      <path d="M12 20h9" />
...
export function IconEliminar({ className }) {
  return (
    <svg {...base({ className })}>
...
export function IconCaja({ className }) {
  return (
    <svg {...base({ className })}>
...
export function IconUsuarios({ className }) {
  return (
    <svg {...base({ className })}>
...
export function IconCandado({ className }) {
  return (
    <svg {...base({ className })}>
...
export function IconSubir({ className }) {
  return (
    <svg {...base({ className })}>
...
export function IconDescargar({ className }) {
  return (
    <svg {...base({ className })}>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
...
export function IconEngranaje({ className }) {
  return (
    <svg {...base({ className })}>
      <circle cx="12" cy="12" r="3" />
...
export function IconFiltro({ className }) {
  return (
    <svg {...base({ className })}>
